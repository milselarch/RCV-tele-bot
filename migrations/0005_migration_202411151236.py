...
def forward(old_orm, new_orm):
    callbackcontextstate = new_orm['callbackcontextstate']
    return [
        # Apply default value datetime.datetime(2024, 11, 15, 12, 36, 19, 491933) to the field callbackcontextstate.last_updated_at,
        callbackcontextstate.update({callbackcontextstate.last_updated_at: datetime.datetime(2024, 11, 15, 12, 36, 19, 491933)}).where(callbackcontextstate.last_updated_at.is_null(True)),
    ]
